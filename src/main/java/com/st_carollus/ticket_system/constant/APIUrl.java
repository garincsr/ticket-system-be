package com.st_carollus.ticket_system.constant;

public class APIUrl {
    private static final String VERSION_API = "/api/v1";
    public static final String USER_API = VERSION_API + "/users";
    ...
    public static final String UNIT_API = VERSION_API + "/units";
}
